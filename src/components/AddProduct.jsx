...
const AddProduct = () => {
  ...
  const submit=async (e)=>{
    ...
    try {
      ...
      const response=await axios.post("https://ryankindi.alwaysdata.net/api/add_product",data)
      setLoading("")
  ...
  return (
    <div className='row mt-4 justify-content-center'>
      <div className="card shadow col-md-6 p-5 text-center" style={{backgroundColor: "burlywood"}}>
        <h1>Add Animal</h1>
        ...
        <h5 className='text-success'>{success}</h5>
         ...
         <b className='text-center text-muted'>Browse/upload animal photo</b><br />
         <input type="file"  className='form-control' required accept='image/*' onChange={(e)=>setProductPhoto(e.target.files[0])} /> <br />
         <button type="submit" className="btn text-light" style={{backgroundColor: "#022d05"}}>Upload Product</button>
         </form>
      </div>
    </div>
