...
const MakePayment = () => {
    // destructive/extract the state product that has been sent/parsed to this component
    ...
    const submit=async (e) =>{
        ...
        try{
            ...
            const response=await axios.post("http://ryankindi.alwaysdata.net/api/mpesa_payment",data)
